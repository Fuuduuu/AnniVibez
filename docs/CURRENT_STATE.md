...
- `RUNTIME_CUTOVER_C5` implementation (C5 source scope OPEN with exact files in `docs/ACTIVE_SCOPE_LOCK.md`; amended at baseline `02b5ff1824258bf28d16121517c072d90d0b892a` by `RUNTIME_CUTOVER_C5_CALENDAR_READ_SCOPE_AMEND` to also allow one additive read-only `listCalendarEvents()` accessor in `src/storage/localReplica.js`, closing a calendar collection-read interface gap discovered during C5 TDD without weakening the C3 mutation/transaction boundary — `replicaRepositories.js` still never calls `replica.transact`/`runTransaction` directly; runtime behavior change NONE; C6-C8 LOCKED; runtime cutover C4 ACCEPTED / CHECKPOINTED at final implementation `d2d1dad0e688706609b80172e8b10a50c54d138d`; C3 CHECKPOINTED at `5612953e7c9e07eef411cecc3c6bb5dd5685930d`; C2 CHECKPOINTED at `cdacf4ec2f9b9f0767d485708c5a5e9c4c0f379e`; C1 CHECKPOINTED at `704cc7a815d1df1efdbfba979814aceb94886c09`; Visual Polish V1 and V2 CHECKPOINTED; runtime cutover plan HUMAN ACCEPTED; Phase A IndexedDB foundation ACCEPTED).
