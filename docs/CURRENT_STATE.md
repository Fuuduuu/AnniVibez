...
- `RUNTIME_CUTOVER_C7` is in its final preview gate. Fixed branch/origin and accepted legacy seed remain `c7-storage-cutover` / `https://c7-storage-cutover.annivibe.pages.dev` / `342c1212-7023-48e5-a195-be0f3896748c` from `6123c12567efea7040d5a5995dd8ba5f738c73a1`; Human Step 1 PASS and `PLACE_ORDER_BEFORE` remain locked. Manual C7 forensic/destructive drills are `WAIVED BY HUMAN FOR FINAL ACCEPTANCE GATE`, not executed. Required before final human smoke: exact forward provenance `9dac8c021be1b99bf7ec1227615cb6f3bd874674`, complete accepted C6 automation, focused source review, complete/stable and remote-verified PWA artifacts, and same-alias preview deployment. The final human smoke verifies continuity, Calendar CRUD, household/saved-place save and close/reopen persistence with no unexpected storage state. Cloudflare Pages containment remains verified (`production_branch: main`, automatic production deployments `false`, preview setting `all`, Git integration `github`): a `main` push MUST NOT auto-deploy production, and any unexpected production deployment before C8 is a STOP. Current production is frozen at accidental C6-containing deployment `0cca08f2-3a87-4176-99e2-7bc107bf8ce5`; C8 remains LOCKED.
