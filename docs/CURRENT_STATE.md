...
- `RUNTIME_CUTOVER_C2_SCOPE_OPEN` (docs-only C2 scope-open next; C2 implementation LOCKED; C3-C8 LOCKED; runtime cutover C1 CHECKPOINTED at `704cc7a815d1df1efdbfba979814aceb94886c09`; Visual Polish V1 and V2 CHECKPOINTED; runtime cutover plan HUMAN ACCEPTED; Phase A IndexedDB foundation ACCEPTED).
